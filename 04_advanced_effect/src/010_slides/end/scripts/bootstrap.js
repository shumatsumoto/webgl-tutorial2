...
import { mountNavBtnHandler, mountSkillBtnHandler, mountScrollHandler } from "./component/slide-handler";
...
export async function init() {
  ...
  // slider-worldのボタン制御を追加
  mountNavBtnHandler(".fv__slider", ".fv__btn.prev", ".fv__btn.next", ".fv__text-shader");
  // slider-reflectのボタン制御を追加
  mountSkillBtnHandler(".skill__slider", ".fv__btn.prev.reflect", ".fv__btn.next.reflect", ".skill__ul");
